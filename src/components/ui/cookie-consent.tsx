				...
				<div {...commonWrapperProps}>
					<Card className="m-3 shadow-lg">
						...
						<CardContent className="space-y-2">
							...
							<p className="text-[10px] text-muted-foreground border-l-2 border-primary/30 pl-2 mt-3">
								Note: Strictly necessary cookies for authentication and theme synchronization are active by default to ensure core system operations.
							</p>
							<p className="text-xs text-muted-foreground">
								By clicking <span className="font-medium">"Accept"</span>, you agree to our use of cookies.
							</p>
							<a href={learnMoreHref} className="text-xs text-primary underline underline-offset-4 hover:no-underline">
								Learn more
							</a>
						</CardContent>
				...
				<div {...commonWrapperProps}>
					<Card className="m-3 shadow-lg">
						...
						<CardFooter className="flex gap-2 h-0 py-2 px-4">
							<Button onClick={handleDecline} variant="secondary" size="sm" className="flex-1 rounded-full">
								Decline
							</Button>
					...
					<Card className="mx-3 p-0 py-3 shadow-lg">
						<CardContent className="sm:flex grid gap-4 p-0 px-3.5">
							...
							<div className="flex items-center gap-2 justify-end sm:gap-3">
								<Button onClick={handleDecline} size="sm" variant="secondary" className="text-xs h-7">
									Decline
